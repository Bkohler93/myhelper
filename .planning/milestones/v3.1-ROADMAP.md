...
- [x] **Phase 20: Fix SRCH-04 — Result Count Param** - Add `num_results` query param to SearXNG URL, add test subtest, fix GATE-02 comment, regenerate Phase 18 VERIFICATION frontmatter (1 plan) — not started (completed 2026-04-11)
...
**Plans**: 1 plan
Plans:
- [x] 20-01-PLAN.md — Fix SRCH-04: add num_results param + test subtest, fix GATE-02 comment, regenerate Phase 18 VERIFICATION frontmatter
